...
var ManualCSVRows = [][]string{
	{"Kanye West", "https://docs.google.com/spreadsheets/d/1ciLshH7-ivahdkVV7-9VOvAjthrZnIe6vDTZPhroYBs/edit?usp=sharing", "p4, @kiwieater, Maker, Bobby, SamV1sion, @comptonrapper, Rose, Dr Wolf, Oreo Eater, Arco, @Free The Robots, @Alek, @Commandtechno, Snoop Dogg, Awesomefied, @rocky, @flab, Shadow, Reuben🇮🇪, @razacosmica, @Marcemaire, Solidus Jack, Marin, garfiiieeelld", "Yes", "Yes", "Yes"},
	...
	{"Unc and Phew", "https://docs.google.com/spreadsheets/d/1-JdaCDJOSA6NTmClTnnmEMBGTqNgaw-RZiQ7ulABpO8/edit?usp=drivesdk", "xyan (me), michael", "Yes", "Yes", "Yes"},
}
